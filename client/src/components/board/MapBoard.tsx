...
import { DmDrawer } from '../dm/DmDrawer'
...
export function MapBoard({
  ...
  return (
    <section
      className="flex min-h-0 w-full flex-1 flex-col gap-4 lg:flex-row"
    ...
    >
      <div className="flex min-h-0 min-w-0 flex-1 flex-col">
        <p className="mb-2 max-w-prose text-xs leading-relaxed text-[var(--vtt-text-muted)]">
          {isDm
            ? 'Panel lateral: mapa y PNJs. Rueda o pellizco: zoom. Arrastra el fondo desde un área vacía del mapa.'
                ...
                {!hasMedia ? (
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-[var(--vtt-bg-elevated)] text-center">
                    ...
                    <p className="max-w-sm px-4 text-xs leading-relaxed text-[var(--vtt-text-muted)]">
                      {isDm
                        ? 'Usa el panel lateral: imagen, vídeo directo o enlace tipo youtube.com/watch…'
